...
export default function DispatchStartPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!mileage) {
      setError("Angka odometer awal harus diisi");
      return;
    }
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4 sm:p-6">
        <div className="max-w-md w-full bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-xl text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
          <div className="relative mx-auto w-20 h-20 flex items-center justify-center">
            <div className="absolute inset-0 rounded-full bg-emerald-500/20 dark:bg-emerald-500/10 animate-ping opacity-75" />
            <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center text-white shadow-lg shadow-emerald-500/30">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">
              Inspeksi Awal Berhasil!
            </h1>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Foto kondisi kendaraan dan data odometer awal telah berhasil diverifikasi dan tersimpan.
            </p>
          </div>
          ...
          <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800 text-left space-y-2.5">
            <div className="flex items-center gap-2.5 text-xs text-zinc-600 dark:text-zinc-300">
              ...
              <span>4/4 Foto Sisi Kendaraan Terupload</span>
            </div>
            <div className="flex items-center gap-2.5 text-xs text-zinc-600 dark:text-zinc-300">
              <svg className="w-4 h-4 text-emerald-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span>Odometer: <strong className="font-mono text-zinc-900 dark:text-zinc-100">{mileage} km</strong></span>
            </div>
          </div>

          <p className="text-xs text-zinc-400 dark:text-zinc-500">
            Halaman ini dapat Anda tutup sekarang. Perjalanan aman!
          </p>
        </div>
      </div>
    );
        ...
        <div className="flex items-center justify-between pb-2 border-b border-zinc-200/80 dark:border-zinc-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-500 dark:text-zinc-400">Verifikasi Kendaraan Digital</p>
            </div>
          </div>
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl shadow-lg p-5 sm:p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
              Ambil foto kendaraan dari 4 sisi dan catat odometer awal sebelum memulai perjalanan.
            </p>
          </div>
          ...
          <div className="bg-zinc-50 dark:bg-zinc-800/60 rounded-xl p-3.5 border border-zinc-200/60 dark:border-zinc-800 space-y-2">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={`font-semibold font-mono ${completedPhotosCount === 4 ? "text-emerald-600 dark:text-emerald-400" : "text-zinc-500"}`}>
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-zinc-700 dark:text-zinc-300">
              Odometer Awal (km) <span className="text-rose-500">*</span>
            </label>
            ...
            <p className="text-[11px] text-zinc-400 dark:text-zinc-500">
              Pastikan sesuai dengan angka speedometer pada kendaraan.
            </p>
          </div>
